            ...
            children: <Widget>[
                  ...
                  Container(
                    ...
                    child: ListView(
                      children: <Widget>[
                        ...
                        ListTile(
                          leading: new Text(widget.detail.name,
                            style: TextStyle(fontWeight: FontWeight.bold, fontSize: 17.0),),
                          title: new Row(
                            children: <Widget>[
                              Expanded(
                                child: new  Text("\$${widget.detail.price.toString()}",
                                    style: TextStyle(color: Colors.redAccent, fontSize: 17.0,fontWeight: FontWeight.w600)),
                              ),
                            ],
                          ),
                        ),
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Text("Description",style: TextStyle(fontWeight: FontWeight.w500,fontSize: 12.0),),
                    Padding(
                      padding: EdgeInsets.only(top: 10.0),
                      child: Text("Limited edition, 주말 잘 보내고 계신가요 남녀공용 제품들 입니다 므넴 구경 오세요 주말 잘 보내고 계신가요 남녀공용 제품들 입니다 므넴 구경 오세요"),
                    )
                  ],
                ),
              )
